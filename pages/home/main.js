...
// fetch('https://www.scorebat.com/video-api/v3/competition/england-premier-league/?token=[MjIxMjdfMTY1OTI2NDU3Ml8yMGVhMzAzNTdlMTg5NTBkNTBiMzgxOWYwZDVjYThlMjIwOWVhOTY4]', options)
// 	.then(response => response.json())
// 	.then(response => {console.log(response)
